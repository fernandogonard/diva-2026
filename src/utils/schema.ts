...
export function createOrganizationSchema(): SchemaOrganization {
  return {
    ...
    '@type': 'Organization',
    name: 'Hotel Diva',
    description: 'Hotel en Mar del Plata especializado en turismo, grupos deportivos y eventos. Cocina propia, atención 24hs.',
    url: 'https://hoteldiva.com.ar',
    ...
    logo: 'https://hoteldiva.com.ar/images/logo.png',
  };
}
...
export function createLocalBusinessSchema(): SchemaLocalBusiness {
  return {
    ...
    '@type': 'Hotel',
    name: 'Hotel Diva',
    description: 'Hotel en Mar del Plata con habitaciones para turismo, grupos deportivos, contingentes y eventos. Cocina propia, desayuno buffet y atención personalizada.',
    image: 'https://hoteldiva.com.ar/images/hero.jpg',
    telephone: '+54 9 2235 03-3585',
    priceRange: '$$',
    address: {
      '@type': 'PostalAddress',
